...
export default function Navbar() {
      ...
      >
        <div className={`flex items-center space-x-2 px-3 py-1.5 text-sm rounded-md transition-all duration-300 border ${
          isActive 
            ...
            : 'hover:bg-green-500/20 hover:backdrop-blur-sm border-transparent hover:border-green-500/30 text-gray-300 hover:text-white'
        }`}>
          {icon && <span className={`${
  ...
  const AuthButton = ({ onClick, children, variant = "primary", icon }) => (
    ...
    >
      <div className="absolute inset-0 bg-gradient-to-r from-green-600/20 to-blue-600/20 transform translate-x-full group-hover:translate-x-0 transition-transform duration-500"></div>
  ...
  return (
    <>
    <nav className="sticky top-0 z-50 bg-gradient-to-r from-green-950 via-black to-green-900 border-b border-green-700 shadow-md">
        ...
        <div className="container mx-auto px-4">
          <div className="flex items-center justify-between py-3">
            <div 
              ...
              onClick={() => navigate('/')}
            >
          <img src="/vite.png" alt="PetConnect Logo" className='w-10 h-10 hover:scale-105' />
            ...
            <div className="hidden md:flex items-center space-x-3">
              {!user ? (
                ...
                <>
                  <div className="bg-green-900/30 border border-green-500/20 rounded-md px-3 py-1 flex items-center space-x-2 text-sm">
                    <div className="bg-gradient-to-r from-green-500 to-blue-500 w-7 h-7 rounded-full flex items-center justify-center text-white font-bold">
                    ...
                    <div>
                      ...
                      <div className="text-xs text-green-400 font-semibold">
                        Invite Code:
                        <span className="ml-1 px-1 py-0.5 rounded bg-green-800 text-green-100">
            ...
            <button
              ...
              className="md:hidden p-2 text-green-400 hover:text-green-300 hover:bg-green-500/20 rounded-lg"
            >
        ...
        <div className={`md:hidden transition-all duration-300 overflow-hidden ${
          ...
          <div className="bg-black/90 backdrop-blur-xl border-t border-green-500/20 px-4 py-3 space-y-2 text-sm">
            {user && (
              <>
                <NavLink to="/chat" icon={<MessageCircle className="w-4 h-4" />}>
                  Secure Chat
                ...
                {/* Mobile User Info */}
                <div className="mt-3 p-3 rounded-md bg-green-900/30 border border-green-500/30">
                    ...
                    <div className="flex items-center space-x-2">
                      ...
                      <div>
                        ...
                        <div className="text-green-400 text-xs font-semibold">
                          Invite Code: <span className="bg-green-800 px-1 py-0.5 rounded text-white">{user.invite_code || 'N/A'}</span>
                        </div>
                      </div>
                    </div>
                    <button
